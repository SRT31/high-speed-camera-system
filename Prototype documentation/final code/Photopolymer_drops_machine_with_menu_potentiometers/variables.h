...
#define Pot_3_pin (A7)      //was A6
#define Pot_2_pin (A6)      //was A7
#define Pot_1_pin (A1)      //was A3
#define Start_Pb_Pin (3)    //was D10
#define SENSOR_IN (A0)      //was A1
#define PULSE_OUT (9)       //was D9
#define STEPPER_DIR_PIN (2) //was D7
#define STEPPER_STEP_PIN (5)//was D6
